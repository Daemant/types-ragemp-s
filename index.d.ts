...
interface PlayerMp extends EntityMp {
	...
	giveWeapon(
		weaponHash: RageEnums.Hashes.Weapon | HashOrString,
		ammo: number
	): void;
	giveWeapon(
		weaponHashes: (RageEnums.Hashes.Weapon | HashOrString)[],
		ammo: number
	): void;
	...
	putIntoVehicle(
		vehicle: VehicleMp,
		seat: RageEnums.VehicleSeat | number
	): void;
	...
	setWeaponAmmo(
		weapon: RageEnums.Hashes.Weapon | HashOrString,
		ammo: number
	): void;
